...
const playlist = [
    ...
    { title: "ПМ - Буду твоим пёсиком", description: "Твоя самая прослушиваемая песня за 2025 год вххвхв, честоно говоря после того как мы поиграли в тот режим в рб, я очень опошляю её представляя тебя на поводке кхм. Кто хорошая девочка?) ", src: "music/PM_Pesik.mp3"},
